...
const navItems = [
  ...
  { label: 'My Applications', icon: '📄', path: '/dashboard/applications',match: (p) => p === '/dashboard/applications' },
  { label: 'Find Jobs',       icon: '🔍', path: '/dashboard/find-jobs',   match: (p) => p === '/dashboard/find-jobs' },
